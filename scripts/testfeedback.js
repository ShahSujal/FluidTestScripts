...
export const mainnam = async () => {
    ...
    if (!FEEDBACK_PRIVATE_KEY) {
        throw new Error("FEEDBACK_PRIVATE_KEY not set in .env file - write operations require a signer");
    }
    // Create signers
    ...
    const feedback = await sdk.giveFeedback(data.newAgentId, data.feedbackFile, "");
    ...
    console.log("=".repeat(70));
    try {
        const retrievedFeedback = await sdk.getFeedback(data.newAgentId, await signer.getAddress(), feedbackIndex);
