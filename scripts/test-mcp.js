...
async function testMCPConnection(mcpUrl) {
...
async function main() {
    try {
        ...
        const agent = sdk.createAgent(`MCP Agent ${Date.now()}`, "An agent with MCP server capabilities for testing", "ipfs://QmMCPTestAgent");
